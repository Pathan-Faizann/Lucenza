  ...
  return (
    <>
     <div className='par d-flex justify-content-around align-items-center'>
      <div className='row  cont justify-content-around align-items-center'>
        ...
        <div className='col-6 part-2 animate__animated animate__fadeInRight animate__slow'>
          <img className='img-fluid img ' src="/Fhero.jpg" alt="" />
          <img className='img-fluid anime animate__animated animate__fadeInDown animate__slower animate__delay-1s ' src="/aniFin.png" alt="" />
          </div>
      </div>
